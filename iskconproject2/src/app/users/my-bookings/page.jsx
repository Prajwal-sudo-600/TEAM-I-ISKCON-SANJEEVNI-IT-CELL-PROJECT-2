...
import { getMyBookings } from '@/actions/userBookingsActions'
  ...
  return (
    <DashboardLayout>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-peacock mb-2">
            My Bookings
          </h1>
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            filteredBookings.map(booking => (
              <div
                key={booking.id}
                className="bg-white rounded-xl p-5 shadow-sm border border-gold/50"
              >
